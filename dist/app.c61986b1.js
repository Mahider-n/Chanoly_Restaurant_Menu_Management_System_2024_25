...
var api = exports.api = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return fetch("".concat(BASE_URL, "/auth/login"), {
              method: "POST",
              headers: {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return fetch("".concat(BASE_URL, "/auth/register"), {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
              },
  ...
  getMenu: function getMenu(token) {
    return _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      var response, errorText, res;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            console.log("Fetching menu with token:", token);
            _context3.next = 3;
            return fetch("".concat(BASE_URL, "/menu"), {
              method: "GET",
              headers: {
...
},{}],"auth.ts":[function(require,module,exports) {
"use strict";
...
var UI = exports.UI = /*#__PURE__*/function () {
  ...
  return _createClass(UI, null, [{
    ...
    key: "showAuthContainer",
    value: function showAuthContainer() {
      document.getElementById("auth-container").classList.remove("hidden");
      document.getElementById("menu-container").classList.add("hidden");
    }
  }, {
    key: "showMenuContainer",
    value: function showMenuContainer() {
...
var App = /*#__PURE__*/function () {
  ...
  return _createClass(App, [{
    ...
    key: "loadMenu",
    value: function () {
      var _loadMenu = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var token, menuItems;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              token = _auth.Auth.getToken();
              _context.next = 4;
              return _api.api.getMenu(token);
            case 4:
              menuItems = _context.sent;
              _ui.UI.renderMenu(menuItems);
              _ui.UI.showMenuContainer();
              _context.next = 14;
              break;
            case 9:
              _context.prev = 9;
              _context.t0 = _context["catch"](0);
              console.error("Failed to load menu:", _context.t0);
              _auth.Auth.removeToken();
              this.loadAuth();
            case 14:
            case "end":
              return _context.stop();
    ...
    value: function loadAuth() {
      _ui.UI.renderAuthForm();
      _ui.UI.showAuthContainer();
    }
  }, {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return _this.handleLogin(target);
              case 5:
                _context2.next = 10;
                break;
              case 7:
                ...
                _context2.next = 10;
                return _this.handleSignup(target);
              case 10:
              case "end":
                return _context2.stop();
            }
    ...
    key: "handleLogin",
    value: function () {
      var _handleLogin = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(form) {
        var email, password, _yield$api$login, access_token;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.prev = 2;
              _context3.next = 5;
              return _api.api.login(email, password);
            case 5:
              _yield$api$login = _context3.sent;
              access_token = _yield$api$login.access_token;
              _auth.Auth.setToken(access_token);
              this.loadMenu();
              _context3.next = 15;
              break;
            case 11:
    ...
    key: "handleSignup",
    value: function () {
      var _handleSignup = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(form) {
        var name, email, password, _yield$api$signup, access_token;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.prev = 3;
              _context4.next = 6;
              return _api.api.signup(name, email, password);
            case 6:
              _yield$api$signup = _context4.sent;
              access_token = _yield$api$signup.access_token;
              _auth.Auth.setToken(access_token);
              this.loadMenu();
              _context4.next = 16;
              break;
            case 12:
              ...
              console.error("Signup failed:", _context4.t0);
...
new App();
},{"./api":"api.ts","./auth":"auth.ts","./ui":"ui.ts"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
